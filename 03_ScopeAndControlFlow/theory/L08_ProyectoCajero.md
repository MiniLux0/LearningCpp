# Lección 08: Mini-Proyecto (Cajero Automático)

¡Has llegado al final del Módulo 03! 

Durante este módulo aprendiste a romper el flujo estricto del programa: aprendiste a tomar desvíos con `if` y `switch`, a repetir acciones con bucles, y descubriste los peligros invisibles del *Scope* y la RAM.

Ahora es el momento de juntarlo todo en un programa real.
