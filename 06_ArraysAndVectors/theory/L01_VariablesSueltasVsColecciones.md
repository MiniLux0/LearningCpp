...
```text
MEMORIA STACK (Variables Sueltas Desconectadas):
┌────────────────┬────────────────┬────────────────┐
│ nota1 (0x1000) │ nota2 (0x1004) │ nota3 (0x1008) │ ... (No indexables)
│ Valor: 18      │ Valor: 15      │ Valor: 20      │
└────────────────┴────────────────┴────────────────┘
```
...
```text
MEMORIA CONTIGUA (Colección Indexable):
Índice:     [0]              [1]              [2]
      ┌────────────────┬────────────────┬────────────────┐
      │  Elemento 0    │  Elemento 1    │  Elemento 2    │
      │   Valor: 18    │   Valor: 15    │   Valor: 20    │
      └────────────────┴────────────────┴────────────────┘
      Dirección base   Base + 1*(size)  Base + 2*(size)
```
